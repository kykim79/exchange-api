...
import com.ktoy.exchange.api.callback.api.BitfinexOrderHandler;
import com.ktoy.exchange.api.entity.*;
import com.ktoy.exchange.api.manager.OrderManager;
...
import com.ktoy.exchange.api.callback.api.NotificationHandler;
...
public class OrderManagerTest {
	...
	public void testOrderSubmissionFailed() throws APIException, InterruptedException {
		...
		final Consumer<ExchangeOrder> orderCallback = (e) -> {
			...
			Assert.assertEquals(BitfinexCurrencyPair.BTC_USD.toSymbolString(), e.getSymbol());
	...
	public void testOrderChannelHandler1() throws APIException {
		...
		final JSONArray jsonArray = new JSONArray(jsonString);
		final BitfinexOrderHandler orderHandler = new BitfinexOrderHandler();
		final BitfinexApiBroker bitfinexApiBroker = buildMockedBitfinexConnection();
