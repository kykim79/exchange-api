...
public class Candlestick {
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
        ...
        .append("open", conv(open))
        .append("high", conv(high))
        .append("low", conv(low))
        .append("close", conv(close))
  ...
  private String conv(String value) {
    //return String.format("%f", Double.parseDouble(value) * 1054 * 1.0685); //eth
    return String.format("%f", Double.parseDouble(value) * 1052 * 1.0701); //btc
  }
}
