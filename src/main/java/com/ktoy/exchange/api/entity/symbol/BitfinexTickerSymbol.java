...
public class BitfinexTickerSymbol implements ChannelSymbol {
	...
	public BitfinexTickerSymbol(final BitfinexCurrencyPair symbol, final Timeframe timeframe) {
		this.symbol = symbol;
	...
	public String toSymbolString() {
		return "trade:" + timeframe.getBitfinexString() + ":" + symbol.toSymbolString();
	}
	 ...
	 * @return
	 */
	public static BitfinexTickerSymbol fromString(final String symbol) {
		...
		return new BitfinexTickerSymbol(
	...
	public boolean equals(final Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final BitfinexTickerSymbol other = (BitfinexTickerSymbol) obj;
		if (symbol == null) {
