...
public class GdaxCandlestickHandler implements ChannelCallbackHandler {
	...
	public void handleChannelData(final ApiBroker apiBroker,
		...
		final GdaxCandlestickSymbol candlestickSymbol = (GdaxCandlestickSymbol) channelSymbol;
	...
	private void parseCandlestick(final List<Tick> ticksBuffer, final JSONArray parts) {
		...
		JSONObject jsonObject = parts.getJSONObject(0);
