...
public class BitfinexSubscribeOrderbookCommand extends AbstractAPICommand {
	...
	public BitfinexSubscribeOrderbookCommand(final OrderbookConfiguration orderbookConfiguration) {
	...
	public String getCommand(final ApiBroker apiBroker) throws CommandException {
		...
		subscribeJson.put("symbol", orderbookConfiguration.getCurrencyPair().toSymbolString());
