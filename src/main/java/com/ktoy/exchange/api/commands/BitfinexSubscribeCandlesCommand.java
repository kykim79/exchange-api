...
public class BitfinexSubscribeCandlesCommand extends AbstractAPICommand {

	private final ChannelSymbol symbol;

	public BitfinexSubscribeCandlesCommand(final ChannelSymbol symbol) {
		this.symbol = symbol;
	}
	...
	public String getCommand(final ApiBroker apiBroker) {
		...
		subscribeJson.put("key", symbol.toSymbolString());
