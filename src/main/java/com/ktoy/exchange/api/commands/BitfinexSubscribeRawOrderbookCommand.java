...
public class BitfinexSubscribeRawOrderbookCommand extends AbstractAPICommand {
	...
	public BitfinexSubscribeRawOrderbookCommand(final RawOrderbookConfiguration orderbookConfiguration) {
	...
	public String getCommand(final ApiBroker apiBroker) throws CommandException {
		...
		subscribeJson.put("symbol", rawOrderbookConfiguration.getCurrencyPair().toSymbolString());
