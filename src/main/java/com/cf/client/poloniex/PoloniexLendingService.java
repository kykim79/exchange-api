...
public class PoloniexLendingService implements LendingService {
    private final static Logger LOGGER = LoggerFactory.getLogger(PoloniexLendingService.class);
    ...
    public List<PoloniexLendingHistory> returnLendingHistory(int hours, int limit) {
        ...
        try {
            ...
            LOGGER.trace("Retrieved and mapped {} {} {} lendingHistory in {} ms", lendingHistory.size(), hours, limit, System.currentTimeMillis() - start);
            return lendingHistory;
        } catch (Exception ex) {
            LOGGER.error("Error retrieving lendingHistory for {} {} - {}", hours, limit, ex.getMessage());
        }
    ...
    public PoloniexLendingResult createLoanOffer(String currency, BigDecimal amount, BigDecimal lendingRate, int duration, boolean autoRenew) {
        ...
        try {
            ...
            LOGGER.trace("Executed and mapped createLoanOffer for {} {} {} {} {} in {} ms",
                    currency, amount.toPlainString(), lendingRate.toPlainString(), duration, autoRenew ? 1 : 0,
                    System.currentTimeMillis() - start);
        } catch (Exception ex) {
            LOGGER.error("Error executing createLoanOffer for {} {} {} {} {} - {}",
                    currency, amount.toPlainString(), lendingRate.toPlainString(), duration, autoRenew ? 1 : 0,
                    ex.getMessage());
        }
    ...
    public PoloniexLendingResult cancelLoanOffer(String orderNumber) {
        ...
        try {
            ...
            result = mapper.mapLendingResult(res);
            LOGGER.trace("Executed and mapped cancelLoanOffer for {} in {} ms", orderNumber, System.currentTimeMillis() - start);
        } catch (Exception ex) {
            LOGGER.error("Error executing cancelLoanOffer for {} - {}", orderNumber, ex.getMessage());
        }
    ...
    public PoloniexActiveLoanTypes returnActiveLoans() {
        ...
        try {
            ...
            LOGGER.trace("Retrieved ActiveLoans in {} ms", System.currentTimeMillis() - start);
            return activeLoanTypes;
        } catch (Exception ex) {
            LOGGER.error("Error retrieving ActiveLoans - {}", ex.getMessage());
        }
    ...
    public List<PoloniexLoanOffer> returnOpenLoanOffers(String currency) {
        ...
        try {
            ...
            LOGGER.trace("Retrieved and mapped {} {} OpenLoanOffers in {} ms", currency, offers.size(), System.currentTimeMillis() - start);
            return offers;
        } catch (Exception ex) {
            LOGGER.error("Retrieved and mapped {} {} OpenLoanOffers - {}", currency, offers.size(), ex.getMessage());
        }
    ...
    public PoloniexLendingResult toggleAutoRenew(String orderNumber) {
        ...
        try {
            ...
            result = mapper.mapLendingResult(res);
            LOGGER.trace("Executed and mapped toggleAutoRenew for {} in {} ms", orderNumber, System.currentTimeMillis() - start);
        } catch (Exception ex) {
            LOGGER.error("Error executing toggleAutoRenew for {} - {}", orderNumber, ex.getMessage());
        }
